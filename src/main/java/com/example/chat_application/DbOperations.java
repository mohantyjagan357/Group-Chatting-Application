...
public class DbOperations {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        if(connection == null){
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/chat_application", "root", "root");
        }
    ...
    public static void addUserInDB(String user) throws SQLException {
        ...
        if(rows_affected > 0){
            System.out.println("Successfully inserted the message in DB.");
        }else{
            System.out.println("unable to insert the message in DB.");
        }
